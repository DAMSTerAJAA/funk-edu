...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
    ...
    <footer style={{ borderTop: "1px solid var(--surface-highest)", background: "var(--surface-lowest)", padding: "10px 28px" }}><div className="mono" style={{ maxWidth: 1480, margin: "0 auto", display: "flex", justifyContent: "space-between", fontSize: 10, color: "var(--text-muted)" }}><span>EDUCATIONAL PLATFORM • MEDICAL CONTENT FROM DATABASE</span><span>SERVER VERIFICATION • NOT KKI/SATUSEHAT INTEGRATION</span></div></footer>
  </div>;
}
