  ...
  return (
    <div className="anim-in" style={{ maxWidth: 980, margin: "0 auto" }}>
      <div className="card" style={{ marginBottom: 18 }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 18, alignItems: "flex-start" }}><div><span className="tag tag-amber">PROTOTYPE VERIFICATION</span><h2 style={{ margin: "12px 0 6px" }}>Professional access verification</h2><p style={{ color: "var(--text-secondary)", fontSize: 13.5 }}>Automatic deterministic adapter for prototype use. No browser call or scrape to KKI/SATUSEHAT.</p></div><span className={`tag ${statusClass}`}>{verification.status.replace("_", " ").toUpperCase()}</span></div>
